...
public class RefreshListView extends ListView implements OnScrollListener {
    ...
    private int currentState = PULL_REFRESH;//记录当前状态
    ...
    private void initHeaderView(){
        ...
        headerView.measure(0, 0);//主动通知系统化去测量该view
        headerViewHeight=headerView.getMeasuredHeight();
        headerView.setPadding(0, -headerViewHeight, 0, 0);//设为-headerViewHeight可将该view隐藏
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        switch(ev.getAction()){
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if(deltaY>0&&getFirstVisiblePosition()==0){//getFirstVisiblePosition():返回适配器第一个item的位置
