...
class MsgManager extends Handler {
    ...
    /**
     * Inserts a {@link T} to be displayed.
     *
     * @param appMsg
     */
    void add(T appMsg) {
    ...
    /**
     * Removes all {@link T} from the queue.
     */
    void clearMsg(T appMsg) {
    ...
    /**
     * Displays the next {@link T} within the queue.
     */
    ...
    /**
     * Removes the {@link T}'s view after it's display duration.
     *
     * @param appMsg The {@link T} added to a {@link ViewGroup} and should be removed.s
     */
    private void removeMsg(final T appMsg) {
    ...
    private void addMsgToView(T appMsg) {
    ...
    private static class OutAnimationListener implements Animation.AnimationListener {
        ...
        private OutAnimationListener(T appMsg) {
            this.appMsg = appMsg;
        }
