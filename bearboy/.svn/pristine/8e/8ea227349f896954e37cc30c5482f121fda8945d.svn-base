...
public class RefreshListView extends ListView implements OnScrollListener {
	...
	private void initFooter() {
		footerView = LayoutInflater.from(getContext()).inflate(R.layout.dl_listview_footer, null);
	...
	private void initHeader() {
		headerView = LayoutInflater.from(getContext()).inflate(R.layout.dl_listview_header, null);
